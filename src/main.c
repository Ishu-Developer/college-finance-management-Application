...
void create_main_window() {
    ...
    gtk_label_set_markup(GTK_LABEL(subtitle_label),
        "<span font='20' style='italic' color='#fa8703ff'>"
    ...
    GtkWidget *payroll_tab = gtk_box_new(GTK_ORIENTATION_VERTICAL, 0);  // ✅ DECLARED HERE
    create_payroll_ui(payroll_tab);                                      // ✅ NOW DECLARED
    gtk_notebook_append_page(GTK_NOTEBOOK(content_notebook), payroll_tab,  // ✅ FIXED: content_notebook
                         gtk_label_new("💰 Payroll"));
